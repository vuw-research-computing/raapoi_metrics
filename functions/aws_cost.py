...
A100_cost = 28.5449/8  # cost of A100 based on 2025 A100 cost of p4d.24xlarge on aws
nesi_cost_per_hour = 0.06 # 0.05 NZD on broadwell - their milan cost is 0.08, hence 0.06
A100_cost_nesi = 0.90 #NZD
usd_to_nzd = 1.67 # july 2025 - not used internally at all, apply during analysis
...
def prepare_aws_cost_data():
    ...
    csv_file_path = os.path.join(current_dir, '../reference_data/Amazon EC2 Instance Comparison2025.csv')
