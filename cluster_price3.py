...
job_data_str = subprocess.run(['sacct', '-S', start_date_str, '-E', end_date_str, '--parsable2', '--format=User,JobID,ReqMem,AllocCPUS,Elapsed,TotalCPU,JobName'], stdout=subprocess.PIPE).stdout.decode('utf-8')
